...
def borda_proj_num(linestyle='-', c='k',linewidth=0.5):
    """
    Borda do 0, 90, 180 e 270, ao inves de N, S, L, W
    ...
    plt.axis('equal')
    plt.axis('off')
    plt.text(-0.03,1.06,"$0^o$", fontsize=11)
    plt.text(-0.10,-1.15,"${180}^o$", fontsize=11)
    plt.text(1.05,-0.04,"${90}^o$", fontsize=11)
    plt.text(-1.26,-0.04,"${270}^o$", fontsize=11)
    plt.plot([0,0],[1,1.03],linestyle=linestyle, c=c,linewidth=linewidth)
    plt.plot([0,0],[-1,-1.03],linestyle=linestyle, c=c,linewidth=linewidth)
    plt.plot([1,1.03],[0.,0.0],linestyle=linestyle, c=c,linewidth=linewidth)
    plt.plot([-1,-1.03],[0,0],linestyle=linestyle, c=c,linewidth=linewidth)
